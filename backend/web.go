...
func staticHandler() http.Handler {
	const index = `<!doctype html><html><head><meta charset="utf-8"><title>Pipeline integrity</title></head><body><h1>Pipeline integrity cycles</h1><p id="health">Loading...</p><button id="refresh">Refresh cycles</button><ul id="items"></ul><script src="/app.js"></script></body></html>`
